...
const Content = () => {
    ...
    const fetchMoreMount = async () => {
        ...
        if (dataState.length == 0) {
            const requestData = await getItems(`http://localhost:8000/routes/files/get?skip=${page}&limit=${5}`);
    ...
    return (
        <div className='md:px-28 px-2 py-5 w-full'>
            {cadd && <div className='fixed top-0 left-0 z-50 w-full h-full flex items-center justify-center bg-[#00000044]'>
                            ...
                            <div className="right relative">
                                <div>
                                    <div className="group relative cursor-pointer">
                                        ...
                                        {elem.user.email === myDecodedToken.email && <div
                                            className="invisible absolute -right-4 z-50 flex w-[10rem] flex-col bg-gray-100 py-1 px-4 text-gray-800 shadow-xl group-hover:visible">
                                             <a onClick={() => { handleDelete(elem._id) }} className="my-2 block border-b border-gray-100 py-1 font-semibold text-gray-500 hover:text-black md:mx-2">
                                                Delete
                                            </a> 
                            ...
                            <div className="top">
                                <div className="icons flex flex-row justify-between items-center">
                                    <div className="left flex flex-row">
                                        ...
                                        <div className="comment relative cursor-pointer mr-4">
